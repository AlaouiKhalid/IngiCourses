            ...
            <div class="row align-items-center">
                <div class="col-md-12 col-sm-12 col-lg-5">
                    <div class="team-single-img">
                        <img src="{{url('/landing')}}/img/team-2.jpg" alt="member" class="img-fluid rounded shadow-sm"/>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="client-section-wrap d-flex flex-row align-items-center">
                        ...
                        <ul class="list-inline justify-content-between">
                            <li class="list-inline-item"><img src="{{url('/landing')}}/img/clients-logo-01.png" width="85" alt="client" class="img-fluid"></li>
                            <li class="list-inline-item"><img src="{{url('/landing')}}/img/clients-logo-02.png" width="85" alt="client" class="img-fluid"></li>
                            <li class="list-inline-item"><img src="{{url('/landing')}}/img/clients-logo-03.png" width="85" alt="client" class="img-fluid"></li>
                            <li class="list-inline-item"><img src="{{url('/landing')}}/img/clients-logo-04.png" width="85" alt="client" class="img-fluid"></li>
                            <li class="list-inline-item"><img src="{{url('/landing')}}/img/clients-logo-05.png" width="85" alt="client" class="img-fluid"></li>
                            <li class="list-inline-item"><img src="{{url('/landing')}}/img/clients-logo-06.png" width="85" alt="client" class="img-fluid"></li>
                        </ul>
                    </div>
                </div>
            </div>
