...
<div class="main">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12 col-lg-7">
                    <div class="image-wrap pt-5">
                        <img src="{{url('/landing')}}/img/t1-hero-img.svg" class="img-fluid custom-width" alt="hero"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="call-to-action ptb-70" style="background: url('landing/img/cta-bg.jpg')no-repeat center center / cover">
        <div class="container">
        ...
        <div class="cta-image d-none d-lg-block d-md-block">
            <img src="{{url('/landing')}}/img/cta-1-man.svg" width="200" class="img-left" alt="cta">
            <img src="{{url('/landing')}}/img/cta-1-mike.svg" width="200" class="img-right" alt="cta">
        </div>
    </section>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="services-single text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
                        ...
                        <p class="mb-0">Progressively empower business "outside the box" thinking with resource-leveling
                            partnerships.</p>
                        <a href="services-details" target="_blank" class="detail-link mt-4">Read more <span
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="image-wrap">
                        <img src="{{url('/landing')}}/img/why-choose-us.png" alt="why choose us" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row m-0">
            <div class="col-lg-6 col-md-12 p-0">
                <div class="free-trial-image text-center">
                    <img src="{{url('/landing')}}/img/cta-2-girl-img.jpg" alt="image" class="img-fluid">
                        ...
                        <div class="tab-content feature-tab-content">
                                ...
                                <div class="row justify-content-around">
                                    ...
                                    <div class="col-md-12 col-lg-6">
                                        <div class="img-wrap my-md-3 my-lg-3 my-sm-0">
                                            <img src="{{url('/landing')}}/img/about-1.jpg" alt="about" class="img-fluid rounded shadow-sm">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane mt-5" id="feature-tab-2">
                                <div class="row align-items-center justify-content-between">
                                        ...
                                        <div class="why-choose-us-wrap">
                                            ...
                                            <ul class="list-with-icon">
                                                <li class="d-flex align-items-start">
                                                    <img src="{{url('/landing')}}/img/increase.svg" width="35" class="mr-3" alt="list icon">
                                                ...
                                                <li class="d-flex align-items-start">
                                                    <img src="{{url('/landing')}}/img/search-engine.svg" width="35" class="mr-3" alt="list icon">
                                                    <div class="list-icon-info">
                                                ...
                                                <li class="d-flex align-items-start">
                                                    <img src="{{url('/landing')}}/img/interface.svg" width="35" class="mr-3" alt="list icon">
                                                    <div class="list-icon-info">
                                    ...
                                    <div class="col-md-6 col-lg-6">
                                        <div class="image-wrap">
                                            <img src="{{url('/landing')}}/img/t6-hero-img1.svg" alt="why choose us" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane active mt-5" id="feature-tab-3">
                                <div class="row align-items-center">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="image-wrap">
                                            <img src="{{url('/landing')}}/img/tab-img.png" alt="email" class="img-fluid m-auto">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                    ...
                    <div class="portfolio-container" id="MixItUp">
                        <div class="mix portfolio-item branding" data-ref="mixitup-target">
                            <div class="portfolio-wrapper">
                                <a href="project-details" target="_blank">
                                    ...
                                    <img class="img-fluid" src="{{url('/landing')}}/img/portfolios/3.jpg" alt="portfolio"/>
                        ...
                        <div class="mix portfolio-item other animation" data-ref="mixitup-target">
                            <div class="portfolio-wrapper">
                                <a href="project-details" target="_blank">
                                    <div class="content-overlay"></div>
                                    <img class="img-fluid" src="{{url('/landing')}}/img/portfolios/2.jpg" alt="portfolio"/>
                                    <div class="content-details fadeIn-bottom text-white">
                        ...
                        <div class="mix portfolio-item animation" data-ref="mixitup-target">
                            <div class="portfolio-wrapper">
                                <a href="project-details" target="_blank">
                                    <div class="content-overlay"></div>
                                    <img class="img-fluid" src="{{url('/landing')}}/img/portfolios/4.jpg" alt="portfolio"/>
                                    <div class="content-details fadeIn-bottom text-white">
                        ...
                        <div class="mix portfolio-item branding" data-ref="mixitup-target">
                            <div class="portfolio-wrapper">
                                <a href="project-details" target="_blank">
                                    <div class="content-overlay"></div>
                                    <img class="img-fluid" src="{{url('/landing')}}/img/portfolios/1.jpg" alt="portfolio"/>
                                    <div class="content-details fadeIn-bottom text-white">
                                        <h5 class="text-white mb-1">Web UI/UX Design</h5>
                                        <p>Web, Design</p>
                                    </div>
                        ...
                        <div class="mix portfolio-item animation other" data-ref="mixitup-target">
                            <div class="portfolio-wrapper">
                                <a href="project-details" target="_blank">
                                    <div class="content-overlay"></div>
                                    <img class="img-fluid" src="{{url('/landing')}}/img/portfolios/5.jpg" alt="portfolio"/>
                                    <div class="content-details fadeIn-bottom text-white">
                        ...
                        <div class="mix portfolio-item branding " data-ref="mixitup-target">
                            <div class="portfolio-wrapper">
                                <a href="project-details" target="_blank">
                                    <div class="content-overlay"></div>
                                    <img class="img-fluid" src="{{url('/landing')}}/img/portfolios/6.jpg" alt="portfolio"/>
                                    <div class="content-details fadeIn-bottom text-white">
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        <div class="price-img pt-5">
                            <img src="{{url('/landing')}}/img/priching-img-1.png" alt="price" width="120" class="img-fluid">
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card popular-price text-center single-pricing-pack">
                        <div class="price-img pt-5">
                            <img src="{{url('/landing')}}/img/priching-img-2.png" alt="price" width="120" class="img-fluid">
                        </div>
                        <div class="card-header py-4 border-0 pricing-header">
                ...
                <div class="col-lg-4 col-md-4 col-12">
                    <div class="card text-center single-pricing-pack">
                        <div class="price-img pt-5">
                            <img src="{{url('/landing')}}/img/priching-img-3.png" alt="price" width="120" class="img-fluid">
                        </div>
                        <div class="card-header py-4 border-0 pricing-header">
    ...
    <section class="testimonial-section ptb-100"
             style="background: url('landing/img/testimonial-bg.png')no-repeat center center / cover">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 col-lg-5">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="testimonial-content-wrap">
                        <img src="{{url('/landing')}}/img/testimonial-arrow-top.png" class="img-fluid testimonial-tb-shape shape-top"
                        ...
                        <div class="owl-carousel owl-theme client-testimonial-1 custom-dot testimonial-shape">
                                ...
                                <div class="testimonial-quote-wrap">
                                    <div class="media author-info mb-3">
                                        <div class="author-img mr-3">
                                            <img src="{{url('/landing')}}/img/client-1.jpg" alt="client" class="img-fluid">
                                        </div>
                            ...
                            <div class="item">
                                <div class="testimonial-quote-wrap">
                                    <div class="media author-info mb-3">
                                        <div class="author-img mr-3">
                                            <img src="{{url('/landing')}}/img/client-2.jpg" alt="client" class="img-fluid">
                                        </div>
                                        <div class="media-body text-white">
                            ...
                            <div class="item">
                                <div class="testimonial-quote-wrap">
                                    <div class="media author-info mb-3">
                                        <div class="author-img mr-3">
                                            <img src="{{url('/landing')}}/img/client-3.jpg" alt="client" class="img-fluid">
                                        </div>
                                        <div class="media-body text-white">
                            ...
                            <div class="item">
                                <div class="testimonial-quote-wrap">
                                    <div class="media author-info mb-3">
                                        <div class="author-img mr-3">
                                            <img src="{{url('/landing')}}/img/client-4.jpg" alt="client" class="img-fluid">
                                        </div>
                                        <div class="media-body text-white">
                                            <h5 class="mb-0 text-white">John Charles</h5>
                                            <span>BizBite</span>
                        ...
                        <img src="{{url('/landing')}}/img/testimonial-arrow-bottom.png" class="img-fluid testimonial-tb-shape shape-bottom"
                             alt="testimonial shape">
                    </div>
                </div>
            </div>
    ...
    <div class="client-section ptb-100" style="background: url('landing/img/client-bg.jpg')no-repeat center center / cover">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-6">
