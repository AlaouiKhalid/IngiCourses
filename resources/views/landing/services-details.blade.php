            ...
            <div class="row">
                <div class="col-lg-8 col-md-8">
                    <div class="service-details-wrap">
                        <img src="{{url('/landing')}}/img/slider-img-2.jpg" alt="services" class="img-fluid rounded shadow-sm"/>
                        <div class="services-detail-content mt-4">
                            ...
                            <div class="row mt-5">
                                <div class="col-md-6">
                                    <div class="img-wrap">
                                        <img src="{{url('/landing')}}/img/images.jpg" alt="services" class="img-fluid"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
