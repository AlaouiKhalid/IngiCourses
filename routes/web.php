...
Route::post('reset_password_with_token', 'loginController@resetPassword');
Route::post('/send', 'landing\landingController@store_contact')->name('contact-post');
...
//Route::get('/login', 'landing\landingController@index')->name('login');
...
Route::get('/{any}', 'landing\landingController@index');
